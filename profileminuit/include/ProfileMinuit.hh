 ...
 *
 *  Verbose Levels (for ProfileMinuit class. Different for Iterative solver and Minuit verbose levels)
 *   0: Quiet
...
#ifndef __ProfileMinuit__
#define __ProfileMinuit__
...
namespace qosc {
  ...
  void DefaultProfileMinuitFCN( int&, double*, double&, double[], int );

  class ProfileMinuit : public Fitter {

  public:
    ProfileMinuit();
    virtual ~ProfileMinuit();


    // Function Implementations From Fitter Base Class
    virtual void DoFit();
    virtual void SetFitterInterface( ProfileMinuitI* interface ); /// overriding interface loader to type-check for ProfileMinuitI*
    ProfileMinuitI* GetMMI() { return (ProfileMinuitI*)Fitter::GetFitterInterface(); }; /// way to get interface pointer typed as ProfileMinuitI*
  ...
  public:
    static ProfileMinuit* gGlobalProfileMinuitInstance;
    static ProfileMinuit* GetGlobalInstance() { return gGlobalProfileMinuitInstance; };
    void SetThisInstanceAsGlobal() { ProfileMinuit::gGlobalProfileMinuitInstance = this; };
    // ---------------------------------------------------------------
  ...
  public:
	...
	std::cout << "ProfileMinuit::SetParManager -- ERROR. Any Parameter Manager given to ProfileMinuit must inherit from the ParameterManager class." << std::endl;
	assert(false);
      }
